...
public class Abas extends JPanel{
	...
	public JLabel nomePagina, anonimo;
...
//						gera.lAbas.get(select-1).setLocation(xProximo, 0);
		...
		nomePagina.setBounds(26,0,this.getWidth()-52-this.getHeight(),this.getHeight());
		...
		anonimo = new JLabel();
		anonimo.setBounds(this.getWidth()-this.getHeight(),0,this.getHeight(),this.getHeight());
		anonimo.setIcon(new ImageIcon("imgJanela/iconAnonimo.png"));
		anonimo.setHorizontalAlignment(SwingConstants.CENTER);
		anonimo.setVerticalAlignment(SwingConstants.CENTER);
		if(!anonima)anonimo.setVisible(false);
		this.add(anonimo);
